...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>&nbsp;          </h1>
          <ol class="breadcrumb">
            <li><b><a href="addGallery.php"> Add Gallery </a> </b></li>
          </ol>
        </section>
                    ...
                    <tbody>
                     ...
                     foreach($testimonial as $testimonials)
                      ...
                      <tr>
                        ...
                        <td> <a href="#" class="delete" data="galleryId=<?php  echo $testimonials->galleryId;?>=tb_gallery">Delete <span aria-hidden="true" class="glyphicon glyphicon-remove"></span></a></td>
                      </tr>
                      <?php
						}
					}
